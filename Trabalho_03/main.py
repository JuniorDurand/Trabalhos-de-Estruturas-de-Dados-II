...
if __name__ == "__main__":
	...
	while opcao != 0:
		...
		print("2 - IMPRIMIR GRAFO COM LISTA DE ADJ NA ORDEM INVERSA DE CARREGAMENTO")
		...
		if opcao == 1:
			...
			if repre == 1:
				print(grafo.__repr__())
		
			else:
				print("Algoritmo não faz sentido com matrizes de adjacencias")
